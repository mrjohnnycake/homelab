...
To run the container all the time and have it auto run at 5a every day (that's by it's design), run this container build in the CLI (this is how I run/install it):
```
...
# uncomment these lines if you're using these services
...
* Google "find plex token" to get your specific token
